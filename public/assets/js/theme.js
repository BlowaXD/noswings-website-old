(function($) {
  ...
  // ======================
	...
	// if (window.location.hostname !== 'yakuthemes.com') {
	//   alert('You are not permitted to use gameforest theme without license!');
	//   window.location.replace("https://themeforest.net/item/gameforest-responsive-gaming-html-theme/5007730");
	// }
})(window.jQuery);
